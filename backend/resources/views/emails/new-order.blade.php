...
<body>
    <div class="container">
        ...
        <p>A solicitação <strong>#{{ $order->order_number }}</strong> foi enviada pelo site.</p>
        ...
        <p><strong>Subtotal estimado: R$ {{ number_format((float) $order->subtotal, 2, ',', '.') }}</strong></p>
        <p>Frete, desconto, total final e pagamento serão definidos no atendimento manual.</p>
